...
def get_benchmark_ir_cmd(ctx, src, append_cmd_line_args = True):
    ...
    if ctx.attr.scheduling_options_proto:
        benchmark_ir_args.setdefault("scheduling_options_proto", ctx.attr.scheduling_options_proto)
    if ctx.attr.codegen_options_proto:
        benchmark_ir_args.setdefault("codegen_options_proto", ctx.attr.codegen_options_proto)
